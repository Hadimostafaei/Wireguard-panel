...
```
sudo apt update && sudo apt install -y curl && apt install git -y && curl -fsSL -o download.sh https://raw.githubusercontent.com/Hadimostafaei/Wireguard-panel/refs/heads/main/download.sh && bash download.sh
